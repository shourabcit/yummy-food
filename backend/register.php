                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="../controller/register_user.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="phone" placeholder="Phone Number" name="phone">
                                    <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php
                                        if (isset($_SESSION['errors']['con_psk'])) {
                                        ?>
                                            <span style="color: red;"><?= $_SESSION['errors']['con_psk'] ?></span>
                                        <?php
                                        }
